...
NodeConfig ParseArguments(int argc, char* argv[]) {
    ...
    throwIF(!targetSet, "Argument lipsa: --target-files (sau --origin-root) este obligatoriu");
    ...
    //throwIF(!clusterSet, "Argument lipsa: trebuie specificat macar un --cluster-node");


    //ne asiguram ca nodul specificat in cl face parte din peersVector. nu putem sa avem Node1 <-> Node2 cand doar Node2 face parte din vector<PeerDescriptor>
